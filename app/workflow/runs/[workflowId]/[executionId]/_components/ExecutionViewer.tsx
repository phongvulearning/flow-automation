...
import { GetPharesTotalCost } from "@/lib/helpers/phases";
...
function ExecutionViewer({ initialData }: { initialData: ExecutionData }) {
  ...
  const phaseDetails = useQuery({
    queryKey: ["phasesDetails", selectedPhase, query.data?.status],
  ...
  const creditsConsumed = GetPharesTotalCost(query.data?.phases || []);
      ...
      <aside className="w-[440px] min-w-[440px] max-w-[440px] border-r-2 border-separate flex flex-grow flex-col overflow-hidden">
        <div className="py-4 px-2">
          <ExecutionLabel
            ...
            label="Status"
            value={
              <div className="flex items-center capitalize gap-2 font-semibold">
                <PhaseStatusBadge
          ...
          <ExecutionLabel
            icon={CoinsIcon}
            label={"Creadits consumed"}
            value={<ReactCountUpWrapper value={creditsConsumed} />}
          />
        </div>
        <Separator />
        <div className="flex justify-center items-center py-2 px-4s">
      ...
      <div className="flex size-full">
        ...
        {!isRunning && selectedPhase && phaseDetails.data && (
          <div className="flex flex-col py-4 container gap-4 overflow-auto">
            ...
            <ParamaterViewer
              title="Ouputs"
              subtitle="Ouputs generated by this phase"
...
function ParamaterViewer({
  ...
  return (
    <Card>
      <CardHeader className="rouded-lg rounded-b-none border-b py-4 bg-gray-50 dark:bg-background">
